...
import com.project.orderAPI.repositories.CategoryRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u1 = new User(null,"Rose Mary","rose@email.com","52132789","3652",null);
        User u2 = new User(null,"Markus Peter","markus@email.com","999858855","9985",null);
